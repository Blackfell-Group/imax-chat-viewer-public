...
| ③ | e2e smoke test suite | [`tests/`](tests/) — `npm run test:ng` (**68 specs**) · `npm test` (React reference, 16) · results report in [`project/delivery/test_results.pdf`](project/delivery/test_results.pdf) | Complete |
