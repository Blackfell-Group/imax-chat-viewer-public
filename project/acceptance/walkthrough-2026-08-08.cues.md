...
Capture: `walkthrough-2026-08-08.webm` · total **04:27** · 1600×1000 @2x, silent, pace 2.6.
...
| 03:04 | `15_promote` | 3d | A standing channel worked whole, then the careful path |
| 03:36 | `16_export` | 3d | Export the full verdicted transcript; copy confirms |
| 03:56 | `17_close` | 4 | Close |
