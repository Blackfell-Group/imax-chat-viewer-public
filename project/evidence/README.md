...
| Artifact | What it is |
|---|---|
| `e2e-results-2026-08-08.json` | **Current run** — full Playwright JSON, delivered Angular build (55 specs) against ng serve + live mocks. The source `scripts/make-test-report.js` reads to produce the D3 report |
