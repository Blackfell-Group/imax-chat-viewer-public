...
|---|---|---|
| **Demo (primary)** | `RiverHawk_IMAX_Walkthrough_2026-08-08.mp4` (4:05, 1600×1000) | ✅ narrated — the working product end to end, with each design finding explained where it shows on screen |
| Capability-only cut | `RiverHawk_IMAX_Walkthrough_2026-08-08_capability.mp4` (3:49) | Same footage without the design derivation, for audiences who want the capability and not the reasoning |
