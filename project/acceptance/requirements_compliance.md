...
[`milestone_record.md`](milestone_record.md). A full clause-by-clause audit of the executed
agreement, including what it requires that this matrix never covered, is in
[`signed_ot_audit.md`](signed_ot_audit.md).

Scored against **`v1.2.1-prototype`**. `v1.1.0-prototype` preceded the 7 August work
