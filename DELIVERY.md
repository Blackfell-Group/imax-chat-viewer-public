...
5. **Walkthrough re-recorded and narrated** —
   [`RiverHawk_IMAX_Walkthrough_2026-08-07.mp4`](project/acceptance/RiverHawk_IMAX_Walkthrough_2026-08-07.mp4),
   4:08. Re-captured against the 7 August build because the twelve closed defects are all
   visible on screen. Script in [`narration_script.md`](project/acceptance/narration_script.md),
   text in `narration.json`, rebuilt with
   `node scripts/capture-walkthrough.js && ./scripts/build-walkthrough.sh`.
