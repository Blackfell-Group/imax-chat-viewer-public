...
| Artifact | What it is |
|---|---|
| `e2e-results-2026-08-08.json` | **Current run** — full Playwright JSON, delivered Angular build (68 specs) against ng serve + live mocks. The source `scripts/make-test-report.js` reads to produce the D3 report |
| `react-reference-results-2026-08-08.json` | Same run date, evaluated Phase 2 React reference build (16 specs) |
| `e2e-results-2026-08-01.json` | Full Playwright JSON results, suite as it stood on 1 Aug (30 specs) against ng serve + live mocks |
