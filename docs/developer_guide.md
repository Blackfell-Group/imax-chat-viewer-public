...
`tests/ng/virtual-scroll.spec.js` asserts a *bounded* DOM on a synthetic 2,000-message
thread; a change that quietly reverts windowing fails there rather than in the enclave.
