...
// OCR Image Viewer: vertical stack — the scan, then the extracted text beneath
// it, then the English. (It was a left/right split until 7 Aug; that gave a
// portrait A4 page a landscape half-pane and shrank it to unreadable.)
