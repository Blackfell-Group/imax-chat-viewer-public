...
- **`RiverHawk_IMAX_Walkthrough_2026-08-08.mp4`** (4:05, narrated) — the working product end
...
- **`RiverHawk_IMAX_Walkthrough_2026-08-08_capability.mp4`** (3:49) — the same footage
